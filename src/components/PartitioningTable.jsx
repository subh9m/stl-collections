// Data for the Partitioning component
const partitioningData = [
  { algorithm: 'partition()', syntax: 'partition(first, last, pred)', params: 'iterators, predicate', output: 'iterator', complexity: 'O(n)', desc: 'Partitions range by predicate' },
  { algorithm: 'is_sorted()', syntax: 'is_sorted(first, last)', params: 'iterators', output: 'bool', complexity: 'O(n)', desc: 'Checks if range is sorted' }
];

const tableHeaders = ['Algorithm', 'Syntax', 'Input / Parameters', 'Output / Return', 'Time Complexity', 'Description'];

export default function PartitioningTable() {
  return (
    <section 
      id="partitioning" // ID for sidebar anchor
    ...
    >
      ...
      <div className="p-6 md:p-8 border-b border-gray-200 dark:border-[#333]">
        <h2 className="text-2xl md:text-3xl font-semibold text-gray-900 dark:text-white">
          <span className="font-mono text-red-500 mr-3">F.5</span>
          <span className="font-inter">Partitioning (&lt;algorithm&gt;)</span>
        </h2>
        <p className="mt-2 text-gray-600 dark:text-gray-400 font-light">
          Algorithms for partitioning ranges based on a predicate.
        </p>
      </div>
