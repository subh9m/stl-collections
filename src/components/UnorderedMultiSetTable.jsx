// Data for the Unordered Multiset component
const unorderedMultisetData = [
  { method: 'insert()', syntax: 'ums.insert(x)', params: 'element', output: 'iterator', complexity: 'O(1) average', desc: 'Inserts element (allows duplicates)' },
  { method: 'erase()', syntax: 'ums.erase(x)', params: 'element', output: 'size_t', complexity: 'O(k) average', desc: 'Removes all occurrences of element' },
  { method: 'find()', syntax: 'ums.find(x)', params: 'element', output: 'iterator', complexity: 'O(1) average', desc: 'Finds element, returns iterator' },
  { method: 'count()', syntax: 'ums.count(x)', params: 'element', output: 'size_t', complexity: 'O(k) average', desc: 'Returns number of occurrences' },
  { method: 'size()', syntax: 'ums.size()', params: '—', output: 'size_t', complexity: 'O(1)', desc: 'Returns number of elements' }
];

const tableHeaders = ['Method', 'Syntax', 'Input / Parameters', 'Output / Return', 'Time Complexity', 'Description'];

export default function UnorderedMultisetTable() {
  return (
    <section 
      id="unordered_multiset" // ID for sidebar anchor
    ...
    >
      ...
      <div className="p-6 md:p-8 border-b border-gray-200 dark:border-[#333]">
        <h2 className="text-2xl md:text-3xl font-semibold text-gray-900 dark:text-white">
          <span className="font-mono text-red-500 mr-3">D.2</span>
          <span className="font-inter">Unordered Multiset (Hash-Based, Allows Duplicates)</span>
        </h2>
        <p className="mt-2 text-gray-600 dark:text-gray-400 font-light">
          A hash-table-based container that stores elements, allowing duplicates.
        </p>
      </div>
