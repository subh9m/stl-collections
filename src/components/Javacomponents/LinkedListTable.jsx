// Data for the LinkedList component
const linkedListData = [
  { method: 'add()', syntax: 'list.add(element)', params: 'element', output: 'boolean', complexity: 'O(1)', desc: 'Adds element at end' },
  { method: 'addFirst()', syntax: 'list.addFirst(element)', params: 'element', output: 'void', complexity: 'O(1)', desc: 'Adds element at beginning' },
  { method: 'addLast()', syntax: 'list.addLast(element)', params: 'element', output: 'void', complexity: 'O(1)', desc: 'Adds element at end' },
  { method: 'get()', syntax: 'list.get(index)', params: 'index', output: 'element', complexity: 'O(n)', desc: 'Returns element at index' },
  { method: 'getFirst()', syntax: 'list.getFirst()', params: '—', output: 'element', complexity: 'O(1)', desc: 'Returns first element' },
  { method: 'getLast()', syntax: 'list.getLast()', params: '—', output: 'element', complexity: 'O(1)', desc: 'Returns last element' },
  { method: 'remove()', syntax: 'list.remove(index)', params: 'index', output: 'element', complexity: 'O(n)', desc: 'Removes element at index' },
  { method: 'removeFirst()', syntax: 'list.removeFirst()', params: '—', output: 'element', complexity: 'O(1)', desc: 'Removes first element' },
  { method: 'removeLast()', syntax: 'list.removeLast()', params: '—', output: 'element', complexity: 'O(1)', desc: 'Removes last element' },
...
export default function LinkedListTable() {
  return (
    <section 
      id="linkedList" // ID for sidebar anchor
    ...
    >
      ...
      <div className="p-6 md:p-8 border-b border-gray-200 dark:border-[#333]">
        <h2 className="text-2xl md:text-3xl font-semibold text-gray-900 dark:text-white">
          ...
          <span className="font-inter">LinkedList (Doubly Linked List)</span>
        </h2>
