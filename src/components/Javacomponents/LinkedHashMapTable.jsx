// Data for the LinkedHashMap component
const linkedHashMapData = [
...
export default function LinkedHashMapTable() {
  return (
    <section 
      id="linkedHashMap" // ID for sidebar anchor
    ...
    >
      ...
      <div className="p-6 md:p-8 border-b border-gray-200 dark:border-[#333]">
        <h2 className="text-2xl md:text-3xl font-semibold text-gray-900 dark:text-white">
          ...
          <span className="font-inter">LinkedHashMap (Hash-Based, Insertion Order)</span>
        </h2>
