// Data for the Queue component
const queueData = [
  { method: 'add()', syntax: 'queue.add(element)', params: 'element', output: 'boolean', complexity: 'O(1)', desc: 'Adds element, throws exception if full' },
  { method: 'offer()', syntax: 'queue.offer(element)', params: 'element', output: 'boolean', complexity: 'O(1)', desc: 'Adds element, returns false if full' },
  { method: 'remove()', syntax: 'queue.remove()', params: '—', output: 'element', complexity: 'O(1)', desc: 'Removes and returns head, throws if empty' },
  { method: 'poll()', syntax: 'queue.poll()', params: '—', output: 'element', complexity: 'O(1)', desc: 'Removes and returns head, null if empty' },
  { method: 'element()', syntax: 'queue.element()', params: '—', output: 'element', complexity: 'O(1)', desc: 'Returns head, throws if empty' },
  { method: 'peek()', syntax: 'queue.peek()', params: '—', output: 'element', complexity: 'O(1)', desc: 'Returns head, null if empty' },
  { method: 'size()', syntax: 'queue.size()', params: '—', output: 'int', complexity: 'O(1)', desc: 'Returns number of elements' }
];

const tableHeaders = ['Method', 'Syntax', 'Input / Parameters', 'Output / Return', 'Time Complexity', 'Description'];

export default function QueueJavaTable() {
  return (
    <section 
      id="queue-java" // ID for sidebar anchor
    ...
    >
      ...
      <div className="p-6 md:p-8 border-b border-gray-200 dark:border-[#333]">
        <h2 className="text-2xl md:text-3xl font-semibold text-gray-900 dark:text-white">
          <span className="font-mono text-red-500 mr-3">B.1</span>
          <span className="font-inter">Queue (FIFO - First In First Out)</span>
        </h2>
        <p className="mt-2 text-gray-600 dark:text-gray-400 font-light">
          An interface for collections designed for holding elements prior to processing.
        </p>
      </div>
      ...
      <div className="p-6 bg-gray-50/70 dark:bg-neutral-950/70 border-t border-gray-200 dark:border-[#333]">
        ...
        <p className="mt-2 font-mono text-xs text-gray-600 dark:text-gray-400">
          Use <code className="text-red-600 dark:text-red-500">LinkedList</code> or <code className="text-red-600 dark:text-red-500">ArrayDeque</code> to instantiate a Queue.
        </p>
      </div>
    </section>
  );
