// Data for the HashSet component
const hashSetData = [
  ...
  { method: 'isEmpty()', syntax: 'set.isEmpty()', params: '—', output: 'boolean', complexity: 'O(1)', desc: 'Checks if set is empty' },
  { method: 'clear()', syntax: 'set.clear()', params: '—', output: 'void', complexity: 'O(n)', desc: 'Removes all elements' },
  { method: 'iterator()', syntax: 'set.iterator()', params: '—', output: 'Iterator', complexity: 'O(1)', desc: 'Returns iterator' }
];

const tableHeaders = ['Method', 'Syntax', 'Input / Parameters', 'Output / Return', 'Time Complexity', 'Description'];

export default function HashSetTable() {
  return (
    <section 
      id="hashSet" // ID for sidebar anchor
    ...
    >
      ...
      <div className="p-6 md:p-8 border-b border-gray-200 dark:border-[#333]">
        <h2 className="text-2xl md:text-3xl font-semibold text-gray-900 dark:text-white">
          ...
          <span className="font-inter">HashSet (Hash-Based, Unordered)</span>
        </h2>
      ...
      <div className="p-6 bg-gray-50/70 dark:bg-neutral-950/70 border-t border-gray-200 dark:border-[#333]">
        ...
        <p className="mt-2 font-mono text-xs text-gray-600 dark:text-gray-400">
          No ordering guaranteed. Allows one null element.
        </p>
      </div>
    </section>
  );
