...
const stackData = [
  { method: 'push()', syntax: 's.push(x)', params: 'element', output: 'void', complexity: 'O(1)', desc: 'Adds element to top' },
  { method: 'pop()', syntax: 's.pop()', params: '—', output: 'void', complexity: 'O(1)', desc: 'Removes top element' },
  { method: 'top()', syntax: 's.top()', params: '—', output: 'element&', complexity: 'O(1)', desc: 'Returns top element' },
  { method: 'size()', syntax: 's.size()', params: '—', output: 'size_t', complexity: 'O(1)', desc: 'Returns number of elements' },
  { method: 'empty()', syntax: 's.empty()', params: '—', output: 'bool', complexity: 'O(1)', desc: 'Checks if stack is empty' }
];
...
export default function StackTable() {
  return (
    <section 
      id="stack" // ID for sidebar anchor
    ...
    >
      ...
      <div className="p-6 md:p-8 border-b border-gray-200 dark:border-[#333]">
        ...
        <p className="mt-2 text-gray-600 dark:text-gray-400 font-light">
          A container adapter that provides Last-In, First-Out (LIFO) access.
        </p>
      </div>
