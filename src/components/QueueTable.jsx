...
const queueData = [
  { method: 'push()', syntax: 'q.push(x)', params: 'element', output: 'void', complexity: 'O(1)', desc: 'Adds element to back' },
  { method: 'pop()', syntax: 'q.pop()', params: '—', output: 'void', complexity: 'O(1)', desc: 'Removes front element' },
  { method: 'front()', syntax: 'q.front()', params: '—', output: 'element&', complexity: 'O(1)', desc: 'Returns front element' },
  { method: 'back()', syntax: 'q.back()', params: '—', output: 'element&', complexity: 'O(1)', desc: 'Returns back element' },
  { method: 'size()', syntax: 'q.size()', params: '—', output: 'size_t', complexity: 'O(1)', desc: 'Returns number of elements' },
...
export default function QueueTable() {
  return (
    <section 
      id="queue" // ID for sidebar anchor
    ...
    >
      ...
      <div className="p-6 md:p-8 border-b border-gray-200 dark:border-[#333]">
        ...
        <p className="mt-2 text-gray-600 dark:text-gray-400 font-light">
          A container adapter that provides First-In, First-Out (FIFO) access.
        </p>
      </div>
