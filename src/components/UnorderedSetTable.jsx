// Data for the Unordered Set component
const unorderedSetData = [
  { method: 'insert()', syntax: 'us.insert(x)', params: 'element', output: 'pair<iterator, bool>', complexity: 'O(1) average', desc: 'Inserts element if not present' },
  { method: 'erase()', syntax: 'us.erase(x)', params: 'element', output: 'size_t', complexity: 'O(1) average', desc: 'Removes element by value' },
  { method: 'find()', syntax: 'us.find(x)', params: 'element', output: 'iterator', complexity: 'O(1) average', desc: 'Finds element, returns iterator' },
  { method: 'count()', syntax: 'us.count(x)', params: 'element', output: 'size_t', complexity: 'O(1) average', desc: 'Returns 1 if present, 0 otherwise' },
  { method: 'size()', syntax: 'us.size()', params: '—', output: 'size_t', complexity: 'O(1)', desc: 'Returns number of elements' },
  { method: 'empty()', syntax: 'us.empty()', params: '—', output: 'bool', complexity: 'O(1)', desc: 'Checks if unordered set is empty' },
  { method: 'clear()', syntax: 'us.clear()', params: '—', output: 'void', complexity: 'O(n)', desc: 'Removes all elements' }
];

const tableHeaders = ['Method', 'Syntax', 'Input / Parameters', 'Output / Return', 'Time Complexity', 'Description'];

export default function UnorderedSetTable() {
  return (
    <section 
      id="unordered_set" // ID for sidebar anchor
    ...
    >
      ...
      <div className="p-6 md:p-8 border-b border-gray-200 dark:border-[#333]">
        <h2 className="text-2xl md:text-3xl font-semibold text-gray-900 dark:text-white">
          ...
          <span className="font-inter">Unordered Set (Hash-Based, Unique Elements)</span>
        </h2>
        <p className="mt-2 text-gray-600 dark:text-gray-400 font-light">
          A hash-table-based container that stores unique elements in no particular order.
        </p>
      </div>
